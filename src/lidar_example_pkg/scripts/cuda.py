...
class PointCloudProcessor:
    ...
    def callback(self, msg):
        if rospy.get_time() % 0.1 > 0.05:  # 약 10fps로 프레임 제한
            rospy.loginfo("Skipping frame for performance reasons.")
            return
        ...
        try:
            ...
            rospy.logerr("CUDA Out of Memory. Skipping this frame.")
            torch.cuda.empty_cache()
